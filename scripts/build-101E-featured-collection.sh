...
echo "=================================="
echo "BUILD 101E - FEATURED COLLECTION"
echo "=================================="

mkdir -p components/home

cat > components/home/FeaturedCollection.tsx <<'ENDOFFILE'
"use client";
      ...
      <div className="relative mx-auto flex min-h-[85vh] max-w-7xl items-center px-8 py-32">
        ...
        >
          ...
          <p className="mt-8 text-lg leading-9 text-white/80">
            Heavyweight hoodies, premium tees and coastal essentials designed
            for cool mornings, ocean air and everyday wear.
          </p>
...
grep -q "FeaturedCollection" "$PAGE" || \
sed -i '/EditorialSection/a import FeaturedCollection from "@/components/home/FeaturedCollection";' "$PAGE"

grep -q "<FeaturedCollection />" "$PAGE" || \
sed -i '/<EditorialSection \/>/a\      <FeaturedCollection />' "$PAGE"
...
echo "=================================="
echo ""
echo "Add your hero image here:"
echo "public/images/editorial/featured-collection.jpg"
