    ...
    <div className="space-y-4">
      <div className="relative overflow-hidden bg-[#e9e6de]">
        <div className="relative aspect-[4/5] overflow-hidden">
          ...
          <button
            type="button"
            className="absolute right-5 top-5 flex h-11 w-11 items-center justify-center rounded-full bg-white/90 text-black shadow-sm backdrop-blur transition hover:scale-110"
          >
