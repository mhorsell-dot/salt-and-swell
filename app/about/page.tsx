      ...
      <section className="relative flex min-h-[80vh] items-center overflow-hidden bg-[#111412] text-white">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 lg:px-10">
          ...
          <p className="mt-10 max-w-xl text-lg leading-8 text-white/80">
            Salt & Swell was created for those drawn to early mornings,
            coastal roads and the freedom found somewhere between land and sea.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-24 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 text-lg leading-8 text-black/65">
            <p>
              Salt & Swell began with a simple idea — create apparel that
              reflects the Australian coastal lifestyle.
            </p>

            <p>
              Pieces designed for mornings chasing waves, afternoons exploring
              empty roads and evenings watching the sun disappear beyond the
              horizon.
            </p>

            <p>
              We believe clothing should feel effortless, durable and connected
      ...
      <section className="px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-8 text-black/60">
            From coastal mornings to long summer days, every Salt & Swell piece
            is designed around comfort, simplicity and the Australian way of life.
          </p>
