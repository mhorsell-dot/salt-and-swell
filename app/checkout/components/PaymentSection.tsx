import { CreditCard, LockKeyhole, Wallet, ShieldCheck } from "lucide-react";
    ...
    <section className="mt-6 rounded-[2rem] border border-black/8 bg-white p-6 shadow-[0_18px_60px_rgba(0,0,0,0.05)]">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-black/50">Secure payment powered by Stripe.</p>
        </div>
      </div>
      ...
      <div className="mt-8 rounded-xl bg-[#f8f8f8] p-5">
        <div className="flex items-center gap-3">
          ...
          <span className="font-medium">PCI DSS Secure Checkout</span>
        </div>
