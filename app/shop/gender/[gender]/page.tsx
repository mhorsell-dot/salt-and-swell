...
const pages = {
  mens: {
    title: "Men",
    gender: "MENS",
    description: "Premium coastal apparel built for everyday adventures and life beside the ocean.",
    image:
  ...
  womens: {
    title: "Women",
    gender: "WOMENS",
    description: "Timeless coastal essentials inspired by salt, sun and endless summer.",
    image:
  ...
  unisex: {
    title: "Unisex",
    gender: "UNISEX",
    description: "Versatile pieces designed for everyone.",
    image:
  ...
  return (
    <main className="min-h-screen bg-[#f5f3ee]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
        <CategoryToolbar title={page.title} productCount={0} />

        <div className="mt-10 grid gap-12 lg:grid-cols-[280px_1fr]">
          <CategoryFilters />

          <LiveProductGrid gender={page.gender} />
        </div>
      </section>
    </main>
  );
