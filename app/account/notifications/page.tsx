      ...
      <div className="mx-auto max-w-4xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-4xl font-semibold tracking-tight">Your Journey Updates</h1>
          </div>
        </div>

        <p className="mt-5 text-black/50">Follow every step of your Salt & Swell order journey.</p>

        <div className="mt-10 space-y-5">
          {notifications.length === 0 ? (
            <div className="rounded-[2rem] bg-white p-10 text-center">No journey updates yet.</div>
          ) : (
                ...
                >
                  <div className="flex gap-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-black/55">{notification.message}</p>
                      ...
                      <div className="mt-4 flex items-center gap-3 text-xs uppercase tracking-[0.15em] text-black/35">
                        ...
                        <span>{notification.createdAt.toLocaleDateString("en-AU")}</span>
                      </div>
                    </div>
                  </div>
                </Link>
