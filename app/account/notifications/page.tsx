...
import { Bell, CheckCircle, Package, Truck, CreditCard } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#f4f1ea] px-5 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-3 text-black/50">Stay updated on your Salt & Swell orders.</p>

        <div className="mt-10 space-y-4">
          {notifications.length === 0 ? (
            <div className="rounded-3xl bg-white p-8">No notifications yet.</div>
          ) : (
            notifications.map((notification) => {
              const Icon = getIcon(notification.event);
              ...
              return (
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="font-semibold">{notification.event.replaceAll("_", " ")}</p>
