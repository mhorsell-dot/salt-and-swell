...
echo "========================================"
echo "BUILD 041C.2"
echo "Customer Profile Page"
echo "========================================"

cat > app/account/profile/page.tsx <<'TS'
      ...
      <section className="mt-12 rounded-3xl border border-black/10 p-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-2 rounded-xl bg-black/5 p-4">
              {customer.firstName}
            </div>
          </div>
        ...
        <button
          className="mt-8 rounded-full bg-black px-8 py-4 text-sm font-bold uppercase tracking-wider text-white"
        >
          Save Profile
        </button>
