    ...
    <section className="bg-[#182321] text-white">
      ...
      <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/lifestyle/coast.jpg')",
          }}
        />
        ...
        <div className="flex items-center px-10 py-24 lg:px-20">
          ...
          <div>
            ...
            <p className="mt-10 max-w-xl text-lg leading-9 text-white/75">
              Designed for early surfs, coastal drives, beach fires and
              weekends spent outdoors. Every collection is built to feel
              timeless, comfortable and effortlessly wearable.
            </p>
