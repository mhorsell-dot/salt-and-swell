...
export default function CategoryToolbar({ title, productCount }: Props) {
  return (
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-black/55">
            Premium coastal apparel inspired by salt air, long summer afternoons and life beside the
            ocean.
          </p>
        </div>
        ...
        <div className="flex items-center gap-8">
          <div className="text-right">
            ...
            <p className="text-xs uppercase tracking-[0.3em] text-black/45">Products</p>
          </div>
