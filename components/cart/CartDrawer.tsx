      ...
      >
        <header className="flex h-20 shrink-0 items-center justify-between border-b border-black/10 px-5 sm:px-7">
          <div>
            ...
            <h2 className="mt-1 text-xl font-semibold tracking-[-0.03em]">Your bag</h2>
        ...
        {!isHydrated ? (
          ...
          <>
            ...
            <footer className="shrink-0 border-t border-black/10 bg-[#f7f5ef] px-5 py-5 sm:px-7">
              ...
              <div className="mb-4 grid grid-cols-3 gap-2 rounded-2xl bg-white/60 p-4 text-center text-[10px] font-semibold uppercase tracking-[0.08em] text-black/55">
